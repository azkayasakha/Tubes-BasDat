...
<body>
    <div class="main-container">
        <div class="content">
            ...
            <h3 class="mt-4 text-center">Formulir Tambah Data Anggota</h3>
            ...
            <div class="container mt-4">
                <form method="POST" action="tambahApi.php" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <input required type="text" class="form-control" id="nama" name="nama_siswa" placeholder="John Doe">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="tempat_lahir" class="col-sm-2 col-form-label">Tempat Lahir</label>
                        <div class="col">
                            <input required type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" placeholder="Jakarta">
                        </div>
                    </div>
                    <div class="mb-3 row">
